...
// Para utilizacao do meu array de matrix de led preciso definir o tipo de hardware FC16_HW
...
const char* ssid = "CITTA";
const char* password = "citt@2019";
...
"<body>" \
"<p><b>Jota Freitas Jr - Digite a mensagem</b></p>" \

"<form id=\"data_form\" name=\"frmText\">" \
"<label>Mensagem:<br><input type=\"text\" name=\"Message\" maxlength=\"255\"></label>" \
"<br><br>" \
"<input type = \"radio\" name = \"Invert\" value = \"0\" checked> Normal" \
"<input type = \"radio\" name = \"Invert\" value = \"1\"> Invertido" \
"<br>" \
"<input type = \"radio\" name = \"ScrollType\" value = \"L\" checked> Rolar para Esquerda" \
"<input type = \"radio\" name = \"ScrollType\" value = \"R\"> Rolar para Direita" \
"<br><br>" \
"<label>Velocidade:<br>R&aacutepido<input type=\"range\" name=\"Speed\"min=\"10\" max=\"200\">Lento"\
"<br>" \
"</form>" \
"<br>" \
"<input type=\"submit\" value=\"Enviar Dados\" onclick=\"SendData()\">" \
"</body>" \
"</html>";
